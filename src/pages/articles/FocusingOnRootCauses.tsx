...
const tocItems = [
  ...
  { id: "what-are-root-causes", label: "What Are Root Causes?" },
  { id: "conventional-vs-rcm", label: "Conventional vs RCM Approach" },
  { id: "conclusion", label: "Conclusion" },
];

const FocusingOnRootCauses = () => {
  return (
      ...
      <SidebarLayout tocItems={tocItems} rightSidebar={<CrossLinks context="articles" />}>
        <article className="py-12">
          <h1 className="font-serif text-4xl font-bold text-foreground md:text-5xl mb-6">
            The First RCM Principle - Focusing on Root Causes
          </h1>
...
export default FocusingOnRootCauses;
