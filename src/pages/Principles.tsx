...
import rootCausesDiagram from "@/assets/principles/root-causes-diagram.jpg";
import scrapedKnee from "@/assets/principles/scraped-knee.jpg";
import mindBodyConnection from "@/assets/principles/mind-body-connection.jpg";
import naturalVsArtificial from "@/assets/principles/natural-vs-artificial.jpg";
import physicsMedicine from "@/assets/principles/physics-medicine.jpg";
import magnetotherapy from "@/assets/principles/magnetotherapy.jpg";
import quickResultsTrap from "@/assets/principles/quick-results-trap.jpg";
import pillBox from "@/assets/principles/pill-box.jpg";
import immuneSystem from "@/assets/principles/immune-system.jpg";
import vitaminD from "@/assets/principles/vitamin-d.jpg";
import lifestyleChanges from "@/assets/principles/lifestyle-changes.jpg";
import cellEnvironment from "@/assets/principles/cell-environment.jpg";
import positiveMood from "@/assets/principles/positive-mood.jpg";
import indoorAirQuality from "@/assets/principles/indoor-air-quality.jpg";
import foodChoices from "@/assets/principles/food-choices.jpg";
import seedOils from "@/assets/principles/seed-oils.jpg";
import healthyMeals from "@/assets/principles/healthy-meals.jpg";
import microbiome from "@/assets/principles/microbiome.jpg";
import gutMicrobiome from "@/assets/principles/gut-microbiome.jpg";
import martialArtsTraining from "@/assets/principles/martial-arts-training.jpg";
import handSanitizer from "@/assets/principles/hand-sanitizer.jpg";
import conflictOfInterest from "@/assets/principles/conflict-of-interest.jpg";
import regulatoryCapture from "@/assets/principles/regulatory-capture.jpg";
          ...
          <div className="space-y-16">
            <section id="principle-1" className="scroll-mt-20">
              ...
              <figure className="my-6">
                <img 
                  src={rootCausesDiagram} 
                  alt="Root Causes diagram illustrating the relationship between root causes and health outcomes" 
            ...
            <section id="principle-2" className="scroll-mt-20">
              ...
              <figure className="my-6">
                <img 
                  src={scrapedKnee} 
                  alt="Your body knows how to heal a scraped knee" 
                  className="w-full rounded-lg"
                />
                <figcaption className="text-sm text-muted-foreground mt-2 text-center italic">
                  Your body knows how to heal a scraped knee. You can help it by washing the scrape gently and applying a bandage, but hindering the healing process would only worsen the situation.
                </figcaption>
              </figure>
              ...
              <figure className="my-6">
                <img 
                  src={mindBodyConnection} 
                  alt="Mind-body connection word cloud" 
                  className="w-full rounded-lg"
                />
              </figure>
            </section>
            ...
            <section id="principle-4" className="scroll-mt-20">
              ...
              <figure className="my-6">
                <img 
                  src={naturalVsArtificial} 
                  alt="Natural versus artificial comparison" 
                  className="w-full rounded-lg"
                />
              </figure>
            ...
            <section id="principle-5" className="scroll-mt-20">
              ...
              <figure className="my-6">
                <img 
                  src={physicsMedicine} 
                  alt="Physics and future medicine quote from Einstein" 
                  className="w-full rounded-lg"
                />
              </figure>
              ...
              <figure className="my-6">
                <img 
                  src={magnetotherapy} 
                  alt="Magnetotherapy in a clinical setting" 
                  className="w-full rounded-lg"
                />
                <figcaption className="text-sm text-muted-foreground mt-2 text-center italic">
                  Magnetotherapy in a clinical setting
                </figcaption>
              </figure>
            </section>
            ...
            <section id="principle-6" className="scroll-mt-20">
              ...
              <figure className="my-6">
                <img 
                  src={quickResultsTrap} 
                  alt="The quick results trap in healthcare" 
                  className="w-full rounded-lg"
                />
                <figcaption className="text-sm text-muted-foreground mt-2 text-center italic">
                  If the "get-results-quick" trap in handling chronic disease was visible, it would look something like this. The price for temporary effortless relief is usually taking medication for the rest of one's life.
                </figcaption>
              </figure>
              ...
              <figure className="my-6">
                <img 
                  src={pillBox} 
                  alt="Daily pill box showing progression of medication" 
                  className="w-full rounded-lg"
                />
                <figcaption className="text-sm text-muted-foreground mt-2 text-center italic">
                  It all starts with one pill a day and a quick result. But over time, you find yourself needing more and more tablets to silence a body that keeps telling you it's time to finally address the root causes.
                </figcaption>
              </figure>
            ...
            <section id="principle-7" className="scroll-mt-20">
              ...
              <figure className="my-6">
                <img 
                  src={immuneSystem} 
                  alt="Well-functioning immune system protects you" 
                  className="w-full rounded-lg"
                />
                <figcaption className="text-sm text-muted-foreground mt-2 text-center italic">
                  A well-functioning immune system protects you against infections and cancer – and makes you look younger, too!
                </figcaption>
              </figure>
              ...
              <figure className="my-6">
                ...
                />
                <figcaption className="text-sm text-muted-foreground mt-2 text-center italic">
                  Vitamin D is one of the essential vitamins for our immunity. Given how much time we spend indoors, we often need to supplement it.
                </figcaption>
              </figure>
            </section>
            ...
            <section id="principle-8" className="scroll-mt-20">
              ...
              <figure className="my-6">
                <img 
                  ...
                  alt="Lifestyle changes necessary for health" 
                  className="w-full rounded-lg"
                />
                <figcaption className="text-sm text-muted-foreground mt-2 text-center italic">
                  Changes in your lifestyle and daily routines are necessary to address most of the root causes of illness and health. For long-term success, it's essential to make the changes gradually, one small step at a time.
                </figcaption>
              </figure>
            </section>
            ...
            <section id="principle-9" className="scroll-mt-20">
              ...
              <figure className="my-6">
                <img 
                  src={cellEnvironment} 
                  alt="Cell development influenced by environment" 
                  className="w-full rounded-lg"
                />
              </figure>
              ...
              <figure className="my-6">
                <img 
                  src={positiveMood} 
                  alt="Being in a good mood supports health" 
                  className="w-full rounded-lg"
                />
                <figcaption className="text-sm text-muted-foreground mt-2 text-center italic">
                  Being in a good mood greatly supports your health in general. Try being in an environment of positive people and reduce your exposure to daily news.
                </figcaption>
              </figure>
              ...
              <figure className="my-6">
                <img 
                  ...
                  alt="Indoor air quality factors" 
                  className="w-full rounded-lg"
                />
                <figcaption className="text-sm text-muted-foreground mt-2 text-center italic">
                  Indoor air quality is one of the most overlooked environmental factors, despite us spending so much time inside buildings. Many volatile chemicals can make it into the air that we inhale many hours a day.
                </figcaption>
              </figure>
            </section>
            ...
            <section id="principle-10" className="scroll-mt-20">
              ...
              <figure className="my-6">
                <img 
                  src={foodChoices} 
                  alt="Making the right food choices daily" 
                  className="w-full rounded-lg"
                />
              </figure>
              ...
              <figure className="my-6">
                <img 
                  src={seedOils} 
                  alt="Refined seed oils factory" 
                  className="w-full rounded-lg"
                />
                <figcaption className="text-sm text-muted-foreground mt-2 text-center italic">
                  Refined seed oils (produced in factories like this one) are probably the most disguised unhealthy food. They're highly inflammatory, contributing to the epidemic of chronic disease.
                </figcaption>
              </figure>
              ...
              <figure className="my-6">
                <img 
                  src={healthyMeals} 
                  alt="Healthy whole food meals" 
                  className="w-full rounded-lg"
                />
                <figcaption className="text-sm text-muted-foreground mt-2 text-center italic">
                  Many delicious meals still await you even if you remove unhealthy foods from your diet. You just need to be a bit more creative and explorative.
                </figcaption>
              </figure>
            </section>
            ...
            <section id="principle-11" className="scroll-mt-20">
              ...
              <figure className="my-6">
                <img 
                  src={microbiome} 
                  alt="Microorganisms under microscope" 
                  className="w-full rounded-lg"
                />
              </figure>
              ...
              <figure className="my-6">
                ...
                />
                <figcaption className="text-sm text-muted-foreground mt-2 text-center italic">
                  The gut microbiome is one of the foundations of our health. Herbicides, preservatives, other chemicals in unhealthy food, antibiotics and remnants of hand sanitizers gradually kill it.
                </figcaption>
              </figure>
              ...
              <figure className="my-6">
                <img 
                  src={martialArtsTraining} 
                  alt="Martial artists training" 
                  className="w-full rounded-lg"
                />
                <figcaption className="text-sm text-muted-foreground mt-2 text-center italic">
                  Martial artists often say that the best training is the actual fight. By avoiding it, your fighting skills deteriorate. Your immune system is no different.
                </figcaption>
              </figure>
              ...
              <figure className="my-6">
                <img 
                  src={handSanitizer} 
                  alt="Over-sanitization warning" 
                  className="w-full rounded-lg"
                />
                <figcaption className="text-sm text-muted-foreground mt-2 text-center italic">
                  This strategy not only doesn't work, it make things way worse in the long run. I'll just repeat – there is no health without constant interaction with microorganisms inside, outside, and on our bodies.
                </figcaption>
              </figure>
            </section>
            ...
            <section id="principle-12" className="scroll-mt-20">
              ...
              <figure className="my-6">
                <img 
                  src={conflictOfInterest} 
                  alt="Root Conflict of Interest in medicine" 
                  className="w-full rounded-lg"
                />
              </figure>
              ...
              <figure className="my-6">
                <img 
                  src={regulatoryCapture} 
                  alt="CDC regulatory capture" 
                  className="w-full rounded-lg"
                />
                <figcaption className="text-sm text-muted-foreground mt-2 text-center italic">
                  Healthcare regulatory agencies, such as the FDA and CDC, were originally intended to protect patients from the effects of the Root Conflict of Interest in medicine. They have since been transformed into primary proponents of pharmaceutical interests—a phenomenon called "regulatory capture."
                </figcaption>
              </figure>
            </section>
          </div>
